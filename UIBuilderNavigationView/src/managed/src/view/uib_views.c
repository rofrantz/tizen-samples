...
void uib_views_init() {
	if(!gst_uib_views.is_init) {
		...
		case e_resolution_CIRCLE_360x360:
			...
			uib_view3_config_delegate_portrait = &uib_view3_config_CIRCLE_360x360_portrait;
			g_view3_config_name_portrait = "common";
			uib_view3_config_delegate_landscape = &uib_view3_config_CIRCLE_360x360_portrait;
